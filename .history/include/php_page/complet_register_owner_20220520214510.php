...
if(isset($_POST["btn_next_owner_signup"])){
        ...
        $queryyy =
            ...
            "INSERT INTO owner_register( full_name, email, password, birthday_date, phone_number, person_id_owner_img, gender, hall_name, liciense_img, max_person_number, license_number) VALUES ('$name', '$email', '$password', '$age','$phone', '$imag_per_id', '$gender', '$name_hall', ' $License_img', '$max_person', '$License_number');";
