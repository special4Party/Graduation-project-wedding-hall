...
<body>
    ...
    <div class="hero">
        <div class="form-box">
            ...
            <form action="/include/php_page/check.php" id="logIn" class="input-group">
                ...
                <input type="checkbox" name="remember-password-all-login" value="remember-password-customer-login" class="check-box"><span class="log-in">Rmember password</span>
